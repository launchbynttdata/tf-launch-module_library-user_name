# tf-launch-module_library-user_name
...
This module generates a user name (or a name that could be used for something else).  Currently, it supports creation using the "random_pet" resource from the Hashicorp
"random" provider.
